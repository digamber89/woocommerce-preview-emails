		...
		class WooCommercePreviewEmails {
			...
			public function generate_page() {
                ...
                <div class="wrap">
                    ...
                    <hr/>
                    <p class="description"> If you have found this plugin useful, please leave a <a
			...
			public function generate_result() {
				...
				if ( is_admin() && isset( $_POST['preview_email'] ) && wp_verify_nonce( $_POST['preview_email'], 'woocommerce_preview_email' ) ):
					...
					if ( $condition == true ) {
						...
						add_filter( 'woocommerce_email_recipient_' . $current_email->id, array(
							$this,
							'no_recipient'
						) );
						...
						} else if ( strpos( $index, 'WC_Email_Booking' ) === 0 && class_exists( 'WC_Booking' ) && is_subclass_of( $current_email, 'WC_Email' ) ) {
							die( 'we are here' );
						} else {
						...
						/*The Woo Way to Do Things Need Exception Handling Edge Cases*/
						remove_filter( 'woocommerce_email_recipient_' . $current_email->id, array(
							$this,
							'no_recipient'
						) );
						?>
                        <div id="tool-options">
                            <div id="tool-wrap">
                                ...
                                <a class="button"
                                   href="<?php echo admin_url(); ?>"><?php _e( 'Back to Admin Area', 'woo-preview-emails' ); ?></a>
