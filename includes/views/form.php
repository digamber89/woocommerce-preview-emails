    ...
    <table class="form-table">
		...
		<?php if ( class_exists( 'WC_Booking' ) ) : ?>
            <tr class="bookings">
                ...
                <th>
                    <label for="bookingID">
						<?php _e( 'Choose Booking', 'woo-preview-emails' ); ?>
                    </label>
                </th>
                <td>
                    <select name="bookingID">
						...
						<?php
							...
							foreach ( $bookings as $booking ) {
								?>
                                <option value="<?php echo $booking->ID ?>" <?php selected( $booking->ID, $orderID ); ?> >
                                    Booking
                                    : <?php echo $booking->ID; ?></option>
							<?php } ?>
                    </select>
                </td>
            </tr>
                ...
                <select name="orderID">
					...
					<?php
						...
						foreach ( $orders as $order ) {
							?>
                            <option value="<?php echo $order->ID ?>" <?php selected( $order->ID, $orderID ); ?> >#order
                ...
                <select name="search_order" id="woo_preview_search_orders" class="woo_preview_search_orders">
					<?php
						if ( ! empty( $_POST['search_order'] ) ) {
							?>
                            <option value="<?php echo $_POST['search_order']; ?>" selected="selected">#order
                                : <?php echo $_POST['search_order']; ?></option>
							<?php
						}
					?>
